...
import hk.DirectoryTraverse 1.0
...
Rectangle {
    ...
    FileDialog {
        ...
        onAccepted: {
            ...
            dirTraverse.folder = fileDialog.currentFolder;
            imageViewer.scale = 1;
            imageViewer.rotation = 0;
            imageViewer.source = fileDialog.currentFile;
            var imageFile = imageViewer.source.toString();
            //remove file:///
